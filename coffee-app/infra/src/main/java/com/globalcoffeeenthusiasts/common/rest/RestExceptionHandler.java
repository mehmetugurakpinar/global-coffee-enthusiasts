...
import com.globalcoffeeenthusiasts.common.exception.CoffeeAppBusinessException;
...
public class RestExceptionHandler extends BaseController {
    ...
    @ExceptionHandler(CoffeeAppBusinessException.class)
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public Response<ErrorResponse> handlePaymentApiBusinessException(CoffeeAppBusinessException ex, Locale locale) {
